namespace Ventas.Services
{
   ...
   T model)
        ...
        public async Task<Response> GetList<T>(string urlBase, string servicePrefix, string controller, string tokenType,
            string accessToken)
        {
            try
            {
        ...
        public async Task<Response> Put<T>(string urlBase, string servicePrefix, string controller, T model, int id, string tokenType,
            string accessToken)
        {
            try
            {
        ...
        public async Task<Response> Delete(string urlBase, string servicePrefix, string controller, int id, string tokenType,
            string accessToken)
        {
            try
            {
